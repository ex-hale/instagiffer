...
class A2Slider(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None, has_field=True, value=1.0, mini=0, maxi=100, decimals=2, step_len=1):
        ...
        self.value_ctrl: None | QtWidgets.QDoubleSpinBox = None
    ...
    def _build_slider(self) -> QtWidgets.QSlider:
    ...
    def _slider_change(self, value):
        ...
        if value != self._value:
            self._value = value
            if self.has_field and self.value_ctrl is not None:
    ...
    def _set_slider_value(self):
        ...
        self.slider.setValue(int(value * self._slider_factor))
    ...
    def has_field(self, state):
        ...
        elif not state and self.has_field and self.value_ctrl is not None:
    ...
    def setMinimum(self, value=None):
        ...
        self.slider.setMinimum(int(self._min * self._slider_factor))
    ...
    def setMaximum(self, value=None):
        ...
        self.slider.setMaximum(int(self._max * self._slider_factor))
    ...
    def setSingleStep(self, value=None):
        ...
        self.slider.setSingleStep(int(self._single_step * self._slider_factor))
    ...
    def setPageStep(self, value=None):
        ...
        self.slider.setPageStep(int(self._page_step * self._slider_factor))
